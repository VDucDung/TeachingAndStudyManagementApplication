...
public class SigningInInterface extends javax.swing.JFrame {

    public SigningInInterface() {
        initComponents();
    ...
    private boolean isAllFieldFull() {
        if (txtUserName.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Tên đăng nhập không được trống!", "Cảnh báo!", JOptionPane.WARNING_MESSAGE);
            txtUserName.requestFocus();
            return false;
        }

        if (txtPassword.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Mật khẩu không được trống!", "Cảnh báo!", JOptionPane.WARNING_MESSAGE);
            txtPassword.requestFocus();
            return false;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SigningInInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
